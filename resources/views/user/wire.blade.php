                ...
                <div class="main-content-wrap">
                    <div class="tf-container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="flex justify-between items-center mb-24 mt-24">
                                    <h6 class="">Wire Transfer Page</h6>
                        ...
                        <div class="row">
                            ...
                            <form action="{{ route('user.wireT') }}" method="post">
                                @csrf
                                ...
                                <div class="col-12">
                                    <div class="wg-box box-quick-trade mb-32">
                                        <div class="title">
                                            <div>
                                                <div class="label-01 mb-2">Wire Trasnfer</div>
                                                <div class="f14-regular text-GrayDark">Fill out this form correctly.</div>
                                            </div>
                                        ...
                                        <div class="quick-trade-wrap">
                                            <div class="quick-trade-list">
                                                ...
                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Beneficiary Account Name
                                                    </div>
                                                    <input name="account_name" type="text" placeholder="type here..."
                                                        class="quick-trade-input style-1" aria-required="true"
                                                        required="">
                                                </div>
                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Bank Name</div>
                                                    <input name="bank_name" placeholder="type here..." type="text"
                                                        class="quick-trade-input style-1" aria-required="true"
                                                        required="">
                                                </div>
                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Beneficiary Account Number
                                                    </div>
                                                    <input name="account_number" type="number"
                                                        placeholder="type here...." class="quick-trade-input style-1"
                                                ...
                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Narration</div>
                                                    <input type="text" name="narration" placeholder="type here..."
                                                        class="quick-trade-input style-1" aria-required="true"
                                                        required="">
                                                </div>

                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Swift Code</div>
                                                    <input type="text" name="swift_code" placeholder="type here..."
                                                        class="quick-trade-input style-1" aria-required="true"
                                                        required="">
                                                </div>

                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Email</div>
                                                ...
                                                <select name="country" class="mb-5 image-select center w-100" required>
                                                    <option value="{{ Auth::user()->country }}">Select Country:
                                            ...
                                            <div class="flex flex-wrap -mx-3">
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                 ...
                                                 <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Beneficiary Account Name
                                                        </label>
                                                        <input name="account_name" type="text" placeholder="Beneficiary Account Name"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                    </div>
                                                </div>
                                                 <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                 ...
                                                 <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        <input name="narration" placeholder="Purpose for transfer"  placeholder="INITIATE AMOUNT"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Swift Code
                                                        </label>
                                                        <input name="swift_code" placeholder="Swift Code"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                    </div>
                                                </div>
