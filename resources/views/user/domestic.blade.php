                ...
                <div class="main-content-wrap">
                    <div class="tf-container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="flex justify-between items-center mb-24 mt-24">
                                    <h6 class="">Domestic Transfer Page</h6>
                        ...
                        <div class="row">
                            ...
                            <form action="{{route('user.domesticT')}}" method="POST">@csrf
                                ...
                                <div class="col-12">
                                    <div class="wg-box box-quick-trade mb-32">
                                        <div class="title">
                                            <div>
                                                <div class="label-01 mb-2">Domestic Trasfer </div>
                                        ...
                                        <div class="quick-trade-wrap">
                                            <div class="quick-trade-list">
                                                ...
                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Beneficiary Account Name</div>
                                                ...
                                                <div class="relative mb-5">
                                                    <div class="f12-medium text-Primary title">Beneficiary Account Number</div>
                                                    <input name="account_number" type="number" placeholder="type here...."
                                                        class="quick-trade-input style-1" aria-required="true"
                                                        required="">
                                                </div>
                                                ...
                                                <input class="password-input bg-Gainsboro" type="password" placeholder="Enter your pin"  name="pin" tabindex="0" value="" aria-required="true" required="">
                                            ...
                                            <div class="flex flex-wrap -mx-3">
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                 ...
                                                 <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label for="first name"
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Select Account Type</label>
                                                        <select name="account_type" id="inputState"
                                                            class="form-control default-select wide focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
