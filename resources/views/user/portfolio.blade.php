                                    ...
                                    <div class="w-100">
                                            ...
                                            <div class="content">
                                                <div>
                                                    <h6 class="counter text-White">
                                                        $<span>{{ number_format((float) Auth::user()->bitcoinWallet->balance, 2) }}
                                                    </h6>
                                                    <div class="f12-medium text-White">BITCOIN<span
                                        ...
                                        <div class="wg-card">
                                            ...
                                            <div class="content">
                                                <div>
                                                    <h6 class="counter">
                                                        $<span>{{ Auth::user()->investments->count() }}
                                                        </span>
                                                    </h6>
                                                    <div class="f12-medium">Investments Count <span
                                                            class="text-Gray"></span></div>
                                                </div>
                                                <div class="chart-small">
                                    ...
                                    <div class="w-100">
                                        <div class="wg-card mb-25">
                                            ...
                                            <div class="content">
                                                <div>
                                                    <h6 class="counter">
                                                        $<span >{{ number_format((float) Auth::user()->usdtWallet->balance, 2) }}
                                                        </span>
                                                    </h6>
                                                    <div class="f12-medium">USDT<span class="text-Gray"></span></div>
                                                </div>
                                                <div class="chart-small">
                                        ...
                                        <div class="wg-card style-1 bg-YellowGreen">
                                            ...
                                            <div class="content">
                                                <div>
                                                    ...
                                                    @endforeach
                                                    <div class="f12-medium">Investments Plan<span
                                                            class="text-Gray"></span></div>
                                                </div>
                                                <div class="chart-small">
                                        ...
                                        <div class="flex justify-between">
                                            <div class="flex gap16 items-center flex-wrap">
                                                <div class="block-legend">
                                                    ...
                                                    <div class="f12-medium"> <span class="text-Gray">Buy</span> <span
                                                            class="f12-bold">$8,420.50</span></div>
                                                </div>
                                                <div class="block-legend">
                                                    <div class="dot bg-Primary"></div>
                                                    <div class="f12-medium"> <span class="text-Gray">Sell</span> <span
                                                            class="f12-bold">$8,420.50</span></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="wg-box gap16 bg-YellowGreen">
                                        <div>
                                            <div class="title mb-12">
                                                <div class="label-01">Investment Plans</div>
                                        ...
                                        <div class="overflow-x-auto">
                                            <table class="tab-sell-order">
                                                <thead>
                                                    <tr>
                                                        <th class="f14-regular">Name</th>
                                                        <th class="f14-regular">Amount (MIN)</th>
                                                        <th class="f14-regular">Amount (MAX)</th>
                                                        <th class="f14-regular">Duration</th>
                                                        <th class="f14-regular">Profit</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach ($plans as $plan)
                                                        <tr>
                                                            <td class="f14-regular">{{ $plan->name }}</td>
                                                            <td class="f14-regular">{{ $plan->minimum }}</td>
                                                            <td class="f14-regular">{{ $plan->maximum }}</td>
                                                            <td class="f14-regular">{{ $plan->duration }}</td>
                                                            <td class="f14-regular">{{ $plan->profit }}</td>
                                                        </tr>
                                                    @endforeach
                                            ...
                                            <a href="{{ route('user.invest') }}"
                                                class="tf-button style-1 f12-bold w-100">
                                                View All
                                                <i class="icon icon-send"></i>
                                            </a>
                                        </div>
