                ...
                <div class="main-content-wrap">
                    <div class="tf-container">
                        ...
                        <div class="row">
                            ...
                            <form action="{{ route('user.edit-password') }}" method="post">@csrf
                                ...
                                <div class="col-12">
                                    <div class="wg-box box-quick-trade mb-32">
                                        <div class="title">
                                            <div>
                                                <div class="label-01 mb-2">Change Password</div>
                                            ...
                                            <div class="quick-trade-list">
                                                <fieldset class="password">
                                                    <input class="password-input bg-Gainsboro" type="password"
                                                        name="old_password" placeholder="Input Old Password" tabindex="0"
                                                ...
                                                <fieldset class="password">
                                                    <input class="password-input bg-Gainsboro" type="password"
                                                        name="new_password" placeholder="Input New Password"
                                                ...
                                                <fieldset class="password">
                                                    <input class="password-input bg-Gainsboro" type="password"
                                                        ...
                                                        placeholder="Confirm New Password" tabindex="0" value=""
                ...
                <div
                    ...
                    <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                        <div class="flex items-center">
                            <p class="mb-0 dark:text-white/80">Change Password</p>
                        </div>
                    </div>
                    <form action="{{ route('user.edit-password') }}" method="post">@csrf
                        <div class="flex-auto p-6">
                            ...
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full max-w-full px-3 shrink-0 md:w-12/12 md:flex-0">
                                    <div class="mb-4">
                                        <label
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Old Password</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-12/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="password" name="new_password" placeholder="Input New Password"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-12/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="first name"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Confirm New Password</label>
                                        <input type="password" name="new_password_confirmation" placeholder="Input New Password"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    </div>
                                </div>
