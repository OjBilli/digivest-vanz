...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title mb-0">ADMIN WIRE DEPOSIT</h4>
        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="alert alert-danger">{{ session('error') }}</div>
                         @endif
                        <form class="form-horizontal" action="{{ route('admin.update-wire') }}" method="POST">@csrf
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-label" for="example-email">Account Name</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="date" class="form-control" name="wire_date">
                                </div>
                            </div>
                            <div class="mt-3">
